...
{
    $WHERE .= "AND t2.`ID_producto` = '".$_REQUEST['producto']."' OR t1.ID_grupo = '-1' OR "
            . "t1.ID_grupo = (SELECT ID_grupo FROM `productos` AS tt1 "
            . "WHERE tt1.ID_producto='".$_REQUEST['producto']."')";
}
